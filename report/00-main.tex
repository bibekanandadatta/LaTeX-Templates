...
%% add more packages here. specially you may have to customize the BibLaTeX.
%% customize other options as needed as well.
...
\geometry{letterpaper, left=1.0in, right=1.0in, top=1.0in, bottom=1.0in, includehead, headheight=30pt, headsep=10pt, includefoot, heightrounded}
