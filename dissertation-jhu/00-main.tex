...
\def\TitleToText{24}                % space between the chapter title to the following text (unit: pt)
...
\captionsetup{belowskip=\CaptionSpacing pt}         % space between figure and caption
...
%% if you want to remove the headers, comment following 2 lines
...
%% if you want to remove the headers, comment out the above line
