...
% if you do not like the white space on top of the chapter, change \ChapterTopSpace to a negative value

\def\ChapterTopSpace{0}             % white space on top of the chapter heading
\def\ChapterToTitle{-12}            % space between chapter to title
\def\TitleToText{24}                % space between the chapter title to the following text (unit is pt)
