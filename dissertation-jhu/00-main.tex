...
%%             PLEASE FOLLOW THE README.MD FILE BEFORE YOU PROCEED           %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Added header option for each chapter. 
...
% if you do not like the white space on top of the chapter, 
% change \ChapterTopSpace to a negative value.

\def\ChapterTopSpace{-60}           % white space on top of the chapter heading
...
%% an option for Palatino font is given below in the BASIC SETTINGS
...
%% change the file name if you have a different name
...
\setlength{\cftfigindent}{\TocIndent pt}        % remove indentation from figures in lof
\setlength{\cfttabindent}{\TocIndent pt}        % remove indentation from tables in lot
...
\captionsetup{belowskip=\CaptionSpacing pt, font=small, labelfont=bf, labelsep=colon, hypcap=true} 
